...
export const authAPI = {
  ...
  resendEmailVerification: () => apiClient.post('/auth/resend-email-verification'),
...
export const taskAPI = {
  ...
  deleteSubtask: (projectId, subTaskId) => apiClient.delete(`/tasks/${projectId}/st/${subTaskId}`),
};

// Note APIs
export const noteAPI = {
  getProjectNotes: (projectId) => apiClient.get(`/notes/${projectId}`),
  getNoteById: (projectId, noteId) => apiClient.get(`/notes/${projectId}/n/${noteId}`),
  createNote: (projectId, data) => apiClient.post(`/notes/${projectId}`, data),
  updateNote: (projectId, noteId, data) => apiClient.put(`/notes/${projectId}/n/${noteId}`, data),
  deleteNote: (projectId, noteId) => apiClient.delete(`/notes/${projectId}/n/${noteId}`),
};
